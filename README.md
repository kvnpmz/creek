...
```
text <text>
tags <tag>,<tag>,*<current tag>

click <tag number>
status <unicode codepoint>
scroll <unicode codepoint>:<up|down>
```

Tag numbers are one-based; `*` marks the current tag. Creek only reports events, leaving their meaning to external programs.
